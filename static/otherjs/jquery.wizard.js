	...
	methods = {
		init: function (element, options) {
			...
			if(opts.topButtons && stepsBar.length && !topActions.length){
				...
				html += '<span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next"><span class="next-text">'+ opts.text.next +'</span><span id="configapi" class="finished-text" onclick="createOpsConfig()">'+ opts.text.finished +'</span></span>';
				html += '</div></div>';
			...
			if(opts.bottomButtons && !bottomActions.length){
				...
				html += '<div class="right-actions"><span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next"><span class="next-text">'+ opts.text.next +'</span><span id="configapi_rd" class="finished-text" onclick="createOpsConfig()">'+ opts.text.finished +'</span></span></div>';
				html += '</div>';
