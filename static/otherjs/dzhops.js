	            ...
	            if (ret.hasOwnProperty('errors')) {
	                ...
	                if (ret.add_res===0) {
	                    ...
	                    <div class="alert alert-success fade in">\
	    					...
	    					<strong>Success!</strong> Please view left Minions Keys panel\
	    				</div>'
	                    );
	                } 
	                    ...
	                    $('#result').html('\
	    	                <div class="alert alert-danger fade in">\
	    	    				<a href="#" class="close" data-dismiss="alert">&times;</a>\
	    	    				<strong>Error!</strong> Add Failure\
	    	    			</div>'
	    	             );
	                }
	            };
		 ...
		 */
	     ...
	     $.post(
	            ...
	            if (ret.hasOwnProperty('errors')) {
	                ...
	                $("#configapi").html("OpenStack Env Setup");
	                $("#configapi_rd").html("OpenStack Env Setup");
	                return false;
	            } else {
	                if (ret.ret_code===0) {
	                    $('#result').html('\
	                    <div class="alert alert-success fade in">\
	    					<a href="#" class="close" data-dismiss="alert">&times;</a>\
	    					<strong>Success!</strong> OpenStack Env Setup Success\
	    				</div>'
	                    );
	                } 
	                    ...
	                    $('#result').html('\
	    	                <div class="alert alert-danger fade in">\
	    	    				<a href="#" class="close" data-dismiss="alert">&times;</a>\
	    	    				<strong>Error!</strong> OpenStack Env Setup Failure\
	    	    			</div>'
	    	             );
	                }
	            };
	     ...
	     $.post(
	            ...
	            if (ret.hasOwnProperty('errors')) {
	                ...
	                if (ret.ret_code===0) {
	                    ...
	                    <div class="alert alert-success fade in">\
	    					<a href="#" class="close" data-dismiss="alert">&times;</a>\
	    					<strong>Success!</strong> Installation is running, please see the check log......\
	    				</div>'
	                    	);
	                } 
	                else if (ret.ret_code===1) {
	                    $('#result').html('\
	    	                <div class="alert alert-danger fade in">\
	    	    				<a href="#" class="close" data-dismiss="alert">&times;</a>\
	    	    				<strong>Error!</strong> Install Failure\
	    	    			</div>'
	    	             );
	                }
	                    ...
	                    $('#result').html('\
	    	                <div class="alert alert-warning fade in">\
	    	    				<a href="#" class="close" data-dismiss="alert">&times;</a>\
	    	    				<strong>Warning!</strong> Installation is already running, please see the check log......\
	    	    			</div>'
	    	             );
	                }
	            };
			...
			if (ret.res===2) {
				...
				$('#result').html('\
					<div class="control-group">\
                    	<label class="controls">Installation Log</label>\
